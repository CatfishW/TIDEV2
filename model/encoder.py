...
class HybridEncoder(nn.Module):
    ...
    def forward(self, feats,support_feat,query_mask=None,support_mask=None,text_features=None):
            ...
            for i, enc_ind in enumerate(self.use_encoder_idx):
                ...
                if self.BMHA:
                    ...
                    for index in range(len(self.fusion_layers)):
                        src_flatten,support_feat = self.fusion_layers[index](src_flatten,support_feat,query_mask_flatten,support_mask)
                ...
                memory = F.interpolate(memory.transpose(1,2),size=org_shape[1]).transpose(1,2)
        ...
        for idx in range(len(self.in_channels) - 1): 
            ...
            if self.BMHA:
                ...
                out_flatten,support_feat = self.fusion_layers[index](out_flatten,support_feat,query_mask_flatten,support_mask)
